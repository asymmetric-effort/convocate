...
func (h *Handler) createBoard(w http.ResponseWriter, r *http.Request) {
	var req struct { Name string `json:"name"`; RepoID string `json:"repoId"` }
	if err := httputil.ReadJSON(r, &req); err != nil {
		httputil.WriteError(w, http.StatusBadRequest, "validation_failed", "invalid request body"); return
	}
...
func (h *Handler) getBoard(w http.ResponseWriter, r *http.Request) {
	...
	if !ok { httputil.WriteError(w, http.StatusNotFound, "not_found", "board not found"); return }
...
func (h *Handler) updateContainer(w http.ResponseWriter, r *http.Request) {
	...
	if !ok { httputil.WriteError(w, http.StatusNotFound, "not_found", "container not found"); return }
...
func (h *Handler) deleteContainer(w http.ResponseWriter, r *http.Request) {
	if !h.store.DeleteContainer(r.PathValue("boardId"), r.PathValue("containerId")) {
		httputil.WriteError(w, http.StatusNotFound, "not_found", "container not found"); return
	}
...
func (h *Handler) getCard(w http.ResponseWriter, r *http.Request) {
	...
	if !ok { httputil.WriteError(w, http.StatusNotFound, "not_found", "card not found"); return }
	httputil.WriteJSON(w, http.StatusOK, c)
}
...
func (h *Handler) deleteCard(w http.ResponseWriter, r *http.Request) {
	if !h.store.DeleteCard(r.PathValue("boardId"), r.PathValue("cardId")) {
		httputil.WriteError(w, http.StatusNotFound, "not_found", "card not found"); return
	}
	w.WriteHeader(http.StatusNoContent)
}
...
func (h *Handler) updateEdge(w http.ResponseWriter, r *http.Request) {
	...
	if !ok { httputil.WriteError(w, http.StatusNotFound, "not_found", "edge not found"); return }
...
func (h *Handler) deleteEdge(w http.ResponseWriter, r *http.Request) {
	if !h.store.DeleteEdge(r.PathValue("boardId"), r.PathValue("edgeId")) {
		httputil.WriteError(w, http.StatusNotFound, "not_found", "edge not found"); return
	}
	w.WriteHeader(http.StatusNoContent)
}
