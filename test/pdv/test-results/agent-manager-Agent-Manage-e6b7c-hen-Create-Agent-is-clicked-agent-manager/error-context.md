...
- Name: agent-manager.spec.ts >> Agent Manager create dialog >> opens when Create Agent is clicked
- Location: tests/agent-manager.spec.ts:98:7
...
- menubar "System panel":
  - button "Activities"
  - text: Agent Manager
  - timer "System clock": Tue, Jun 30 21:23:17
  - button "Mock Admin"
