...
- Name: agent-manager.spec.ts >> Agent Manager create dialog >> validates required fields
- Location: tests/agent-manager.spec.ts:105:7
...
- menubar "System panel":
  - button "Activities"
  - text: Agent Manager
  - timer "System clock": Tue, Jun 30 21:23:41
  - button "Mock Admin"
