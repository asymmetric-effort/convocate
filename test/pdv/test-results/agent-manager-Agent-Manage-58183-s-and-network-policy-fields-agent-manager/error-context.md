...
- Name: agent-manager.spec.ts >> Agent Manager create dialog >> shows capabilities and network policy fields
- Location: tests/agent-manager.spec.ts:114:7
...
- menubar "System panel":
  - button "Activities"
  - text: Agent Manager
  - timer "System clock": Tue, Jun 30 21:24:04
  - button "Mock Admin"
