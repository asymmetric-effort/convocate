...
- Name: agent-manager.spec.ts >> Agent Manager applet >> shows agent count or empty state after loading
- Location: tests/agent-manager.spec.ts:78:7
...
- menubar "System panel":
  - button "Activities"
  - text: Agent Manager
  - timer "System clock": Tue, Jun 30 21:22:54
  - button "Mock Admin"
