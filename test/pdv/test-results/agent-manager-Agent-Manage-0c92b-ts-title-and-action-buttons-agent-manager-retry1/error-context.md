...
- Name: agent-manager.spec.ts >> Agent Manager applet >> displays the toolbar with Agents title and action buttons
- Location: tests/agent-manager.spec.ts:56:7
...
- menubar "System panel":
  - button "Activities"
  - text: Agent Manager
  - timer "System clock": Tue, Jun 30 21:22:18
  - button "Mock Admin"
